								...
								for(var i=0; i<answer.length; i++){
									...
									if(i < 8){
										$("#dis").append("<div class='col-sm-6 col-md-4 col-lg-3 h-100 mb-5'>" + 
							              ...
							              "<img class='img-fluid rounded-3' src='mainassets/assets/img/gallery/" + answer[i].recipe_img + "' alt='...' style='width:333px;height:283px;object-fit: cover;' /></a>" + 
							                "<div class='card-img-overlay ps-0' style='background-color: transparent; text-align: right;'>" + 
							                	"<span class='badge p-2' style='background-color: white;'><a href='javascript:void(0);' onclick='delete1(" + answer[i].recipe_no + ");' style='color:#dc3545;'>" + 
          ...
          <div class="row gx-2" id="dis">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 h-100 mb-5">
              ...
              <a href="javascript:void(0);" onclick="detail(${myzzimrecipelist.recipe_no});" >
          		<img title="상세 페이지로 이동" alt="오류" class="img-fluid rounded-3" src="mainassets/assets/img/gallery/${myzzimrecipelist.recipe_img }" style="width:333px;height:283px;object-fit: cover;" />
              </a>
                <div class="card-img-overlay ps-0" style="background-color: transparent; text-align: right;">
                	<span class="badge p-2" style="background-color: white;">
	                	<a href='javascript:void(0);' onclick="delete1(${myzzimrecipelist.recipe_no});" style="color:#dc3545;"><i class="fas fa-heart"></i></a>
	                </span>
                </div>
                <div class="card-body p-2 " >
                  <div class="d-flex align-items-center mb-1">
                    <div class="flex-1">
                      <h5 class="mb-0 fw-bold text-1000">${myzzimrecipelist.recipe_title }</h5>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 h-100 mb-5 hide" style="display:none;">
              <div class="card card-span h-100 text-white rounded-3" style="margin-bottom:0rem;">
              <a href='javascript:void(0);' onclick="detail(${myzzimrecipelist.recipe_no});">
              <img class="img-fluid rounded-3 h-100" src="mainassets/assets/img/gallery/${myzzimrecipelist.recipe_img }" alt="..." />
              </a>
                <div class="card-img-overlay ps-0" style="background-color: transparent; text-align: right;">
                	<span class="badge p-2" style="background-color: white;">
	                	<a href='javascript:void(0);' onclick="delete1(${myzzimrecipelist.recipe_no});" style="color:#dc3545;"><i class="fas fa-heart"></i></a>
