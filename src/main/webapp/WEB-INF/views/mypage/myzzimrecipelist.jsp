							...
							for(var i=0; i<answer.length; i++){
								...
								if(i < 6){
									$("#dis").append(" <div style='display:inline-block'>" +
											...
											"<img title='상세 페이지로 이동' alt='오류' src='/imgs/" + answer[i].recipe_img1 + "' width='200' height='200'></a><br>" + 
		...
		<c:forEach items="${myzzimrecipelist }" var="myzzimrecipelist" varStatus="status">
			<c:if test="${status.index < 6}">
				<div style="display:inline-block">
					...
					<img title="상세 페이지로 이동" alt="오류" src="/imgs/${myzzimrecipelist.recipe_img1 }" width="200" height="200"></a><br>
