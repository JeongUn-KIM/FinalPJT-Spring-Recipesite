                ...
                <div class="carousel-inner">
                  ...
                  <div class="carousel-item active" data-bs-interval="1">
                    ...
                    <c:forEach items="${popularlist }" begin="0" end="4" var="popularlist">
                      <div class="col-sm-6 col-md-4 col-xl mb-5 h-100">
                        <div class="card card-span h-100 rounded-3"><img class="img-fluid rounded-3" src="mainassets/assets/img/gallery/${popularlist.recipe_img }" alt="..." style="width:333px;height:283px;object-fit: cover;"/>
                          <div class="card-body ps-0">
